...
export class BillingSummaryComponent implements OnInit {
  ...
  exportPackingListPDF(): void {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          '',
          '',
          this.invoice.gatePassNo || 'DI2526001',
        ...
        [
          '',
          '',
          this.invoice.gatePassNo || 'LWDF202501',
          this.formatDate(this.invoice.gatePassNo) || '20-May-2025',
        ],
        [
          '',
          '',
          {
            content: 'Shipping Bill No',
            colSpan: 1,
          },
          this.invoice.gatePassNo || '3293257',
        ],
        ['', '', 'Port Code', this.invoice.gatePassNo || 'INKRI1'],
        [
          {
          ...
          'Date',
          this.formatDate(this.invoice.gatePassNo) || '4-Jul-2025',
        ],
        ['', '', "Exporter's Ref", ''],
        [
          '',
    ...
    /** ========== SHIPPING DETAILS - FIRST PAGE ONLY ========== **/
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          'SHIPPING MARK\nFAN / XMN',
          '1000 Granite - Roughly Trimmed Blocks',
          '',
          '',
          '',
        ],
  ...
  drawFirstPageLayout(doc: any, pageWidth: number): void {
    ...
    doc.text('Granite Exporters & Quarry Owners', pageWidth / 2, 20, {
      align: 'center',
    });
    ...
    doc.text('GSTIN: 29AABFD0471D1ZV, STATE CODE:29', pageWidth / 2, 40, {
      align: 'center',
    });
  }
